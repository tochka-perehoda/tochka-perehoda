...
function openTribute(url){if(window.Telegram?.WebApp?.openLink){window.Telegram.WebApp.openLink(url)}else{window.open(url,'_blank')}}
function buyMini(){openTribute('https://web.tribute.tg/p/EBu')}
function buyProgram(){openTribute('https://web.tribute.tg/p/EBv')}
